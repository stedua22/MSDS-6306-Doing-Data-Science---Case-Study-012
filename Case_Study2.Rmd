...
library(readr)
CaseStudy2CompSet_No_Attrition <- read_csv("~/MSDS_6306_Doing-Data-Science/Unit 14 and 15 Case Study 2/CaseStudy2CompSet No Attrition.csv")
View(CaseStudy2CompSet_No_Attrition)

library(readxl)
CaseStudy2CompSet_No_Salary <- read_excel("~/MSDS_6306_Doing-Data-Science/Unit 14 and 15 Case Study 2/CaseStudy2CompSet No Salary.xlsx")
...
plot(density(fit4_Preds),main = "Model 4 Residual with Job Level, Age, and Years at Company")
